...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.enemy_car = pygame.image.load('.\\img\\enemy_car_2.png')
        self.enemy_car_startx = random.randrange(310, 450)
        self.enemy_car_starty = -600
        self.enemy_car_speed = 5
        self.enemy_car_width = 49
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Mit')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Mit patel", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("patelmit167@gmail.com", True, self.white)
